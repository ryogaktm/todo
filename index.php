...
<body
    ...
    <header>
        ...
        <div class="h-right">
            ...
            <button class="btn" id="btnDailyWorkToggle">一日の作業</button>
    ...
    <div class="wrap">
        ...
        <aside class="completed-panel" id="dailyWorkPanel" aria-hidden="true" style="z-index: 45;">
            <div class="completed-header" style="display:flex; justify-content:space-between; align-items:center; background:#17224a; color:#fff;">
                <button class="btn" id="dwPrevDay" style="padding:2px 8px;">◀</button>
                <span id="dwCurrentDate" style="font-weight:bold;"></span>
                <button class="btn" id="dwNextDay" style="padding:2px 8px;">▶</button>
                <button class="shortcut-close" id="dailyWorkClose" style="color:#fff; padding:0 8px;">×</button>
            </div>
            <div class="completed-list" id="dailyWorkList" style="flex:1; overflow:auto; background:#f4f5f7; padding:10px;">
            </div>
            <div style="padding:10px; border-top:1px solid #ccc; background:#e8ecf5;">
                <div style="display:flex; gap:6px; margin-bottom:8px;">
                    <input type="text" id="dwAddTitle" placeholder="タイトル(手動追加)" style="flex:1; padding:6px; font-size:13px; border:1px solid #ccc; border-radius:4px; background:#fff;">
                    <input type="number" id="dwAddHours" placeholder="時間" step="0.25" style="width:60px; padding:6px; font-size:13px; border:1px solid #ccc; border-radius:4px; background:#fff;">
                    <button class="btn" id="dwAddBtn" style="padding:4px 8px;">追加</button>
                </div>
                <div style="text-align:right; font-weight:bold; font-size:16px; color:#17224a;">
                    合計: <span id="dwTotalHours">0</span> h
                </div>
            </div>
        </aside>
        <div class="completed-backdrop" id="dailyWorkBackdrop" aria-hidden="true" style="z-index: 44;"></div>
        ...
        <div class="modal" role="dialog" aria-modal="true" aria-labelledby="modalTitle">
            <header class="modal-head">
                ...
                <div class="modal-head-right est-hours-wrap">
                    <button type="button" class="btn" id="btnFinishWork" style="background:#4CAF50; color:#fff; border:none; margin-right:8px; padding:4px 10px; border-radius:4px; font-weight:bold;">作業終了</button>
